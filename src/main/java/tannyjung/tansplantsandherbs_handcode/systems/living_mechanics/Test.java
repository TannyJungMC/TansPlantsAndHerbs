...
public class Test {
    ...
    public static void click (LevelAccessor level_accessor, Entity entity, BlockPos pos) {
        ...
        Vec3 vec3 = pos.above().getCenter().add(0.0, 0.0, 0.5);
        ...
        if (entities.isEmpty() == false) {
            ...
            // Place
            {
                ...
                if (id.startsWith("tansplantsandherbs") == true) {

                    Entity entity_summon = GameUtils.Misc.summonBlock(level_server, vec3, "Table Preview", "TANSPLANTSANDHERBS-table_preview", 0.0, 0.0, 0.0, 1.0, 1.0, 1.0, 90, 90, id);
