...
@Mod("tansplantsandherbs")
public class TansplantsandherbsMod {
	public static final Logger LOGGER = LogManager.getLogger(TansplantsandherbsMod.class);
	public static final String MODID = "tansplantsandherbs";

	public TansplantsandherbsMod(FMLJavaModLoadingContext context) {
