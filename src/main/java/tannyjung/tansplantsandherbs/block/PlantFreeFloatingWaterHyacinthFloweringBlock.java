...
public class PlantFreeFloatingWaterHyacinthFloweringBlock extends Block implements SimpleWaterloggedBlock {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public PlantFreeFloatingWaterHyacinthFloweringBlock() {
		super(BlockBehaviour.Properties.of().sound(SoundType.LILY_PAD).strength(0.5f, 0f).noCollission().noOcclusion().isRedstoneConductor((bs, br, bp) -> false).replaceable().offsetType(Block.OffsetType.XYZ).ignitedByLava());
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("block.tansplantsandherbs.plant_free_floating_water_hyacinth_flowering.description_0"));
		list.add(Component.translatable("block.tansplantsandherbs.plant_free_floating_water_hyacinth_flowering.description_1"));
		list.add(Component.translatable("block.tansplantsandherbs.plant_free_floating_water_hyacinth_flowering.description_2"));
	}
