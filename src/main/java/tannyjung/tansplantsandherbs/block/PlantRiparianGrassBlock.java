...
public class PlantRiparianGrassBlock extends Block implements SimpleWaterloggedBlock {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public PlantRiparianGrassBlock() {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("block.tansplantsandherbs.plant_riparian_grass.description_0"));
		list.add(Component.translatable("block.tansplantsandherbs.plant_riparian_grass.description_1"));
		list.add(Component.translatable("block.tansplantsandherbs.plant_riparian_grass.description_2"));
	}
