...
public class PlantFreeFloatingWaterHyacinthBlock extends Block implements SimpleWaterloggedBlock {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("block.tansplantsandherbs.plant_free_floating_water_hyacinth.description_0"));
		list.add(Component.translatable("block.tansplantsandherbs.plant_free_floating_water_hyacinth.description_1"));
		list.add(Component.translatable("block.tansplantsandherbs.plant_free_floating_water_hyacinth.description_2"));
	}
