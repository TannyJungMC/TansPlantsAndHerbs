...
public class PlantFreeFloatingDuckweedBlock extends Block implements SimpleWaterloggedBlock {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public PlantFreeFloatingDuckweedBlock() {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("block.tansplantsandherbs.plant_free_floating_duckweed.description_0"));
		list.add(Component.translatable("block.tansplantsandherbs.plant_free_floating_duckweed.description_1"));
		list.add(Component.translatable("block.tansplantsandherbs.plant_free_floating_duckweed.description_2"));
	}
