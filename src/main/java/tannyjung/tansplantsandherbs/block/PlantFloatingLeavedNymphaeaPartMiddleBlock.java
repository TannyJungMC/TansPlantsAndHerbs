...
public class PlantFloatingLeavedNymphaeaPartMiddleBlock extends Block implements SimpleWaterloggedBlock {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public PlantFloatingLeavedNymphaeaPartMiddleBlock() {
