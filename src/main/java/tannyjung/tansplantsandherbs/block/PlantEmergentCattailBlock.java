...
public class PlantEmergentCattailBlock extends Block implements SimpleWaterloggedBlock {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public PlantEmergentCattailBlock() {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("block.tansplantsandherbs.plant_emergent_cattail.description_0"));
		list.add(Component.translatable("block.tansplantsandherbs.plant_emergent_cattail.description_1"));
		list.add(Component.translatable("block.tansplantsandherbs.plant_emergent_cattail.description_2"));
	}
