...
public class PlantRiparianReedBlock extends Block implements SimpleWaterloggedBlock {
	...
	public PlantRiparianReedBlock() {
		super(BlockBehaviour.Properties.of().sound(SoundType.GRASS).strength(2.5f, 0f).noCollission().noOcclusion().isRedstoneConductor((bs, br, bp) -> false).offsetType(Block.OffsetType.XYZ));
