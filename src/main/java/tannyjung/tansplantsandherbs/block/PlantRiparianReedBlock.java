...
public class PlantRiparianReedBlock extends Block implements SimpleWaterloggedBlock {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public PlantRiparianReedBlock() {
		super(BlockBehaviour.Properties.of().sound(SoundType.GRASS).strength(1f, 0f).noCollission().noOcclusion().isRedstoneConductor((bs, br, bp) -> false).replaceable().offsetType(Block.OffsetType.XYZ).ignitedByLava());
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("block.tansplantsandherbs.plant_riparian_reed.description_0"));
		list.add(Component.translatable("block.tansplantsandherbs.plant_riparian_reed.description_1"));
		list.add(Component.translatable("block.tansplantsandherbs.plant_riparian_reed.description_2"));
	}
	...
	public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
		...
		return box(0, 0, 4, 16, 4, 16).move(offset.x, offset.y, offset.z);
	}
