...
public class PlantFloatingLeavedNymphaeaBlock extends Block implements SimpleWaterloggedBlock {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public PlantFloatingLeavedNymphaeaBlock() {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("block.tansplantsandherbs.plant_floating_leaved_nymphaea.description_0"));
		list.add(Component.translatable("block.tansplantsandherbs.plant_floating_leaved_nymphaea.description_1"));
		list.add(Component.translatable("block.tansplantsandherbs.plant_floating_leaved_nymphaea.description_2"));
	}
