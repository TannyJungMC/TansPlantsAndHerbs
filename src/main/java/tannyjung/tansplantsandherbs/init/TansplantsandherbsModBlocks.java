...
public class TansplantsandherbsModBlocks {
	...
	public static final RegistryObject<Block> PLANT_FREE_FLOATING_WATER_HYACINTH_FLOWER;
	public static final RegistryObject<Block> PLANT_FLOATING_LEAVED_NYMPHAEA_TOP_FLOWER;
	static {
		...
		PLANT_FREE_FLOATING_WATER_HYACINTH_FLOWER = REGISTRY.register("plant_free_floating_water_hyacinth_flower", PlantFreeFloatingWaterHyacinthFlowerBlock::new);
		PLANT_FLOATING_LEAVED_NYMPHAEA_TOP_FLOWER = REGISTRY.register("plant_floating_leaved_nymphaea_top_flower", PlantFloatingLeavedNymphaeaTopFlowerBlock::new);
	}
